...
- <b>Basic surveys</b> pay minimum $0.30 per completed survey and this price can go up to $2 per completed survey (it’s a shared revenue model)
...
<img src="{{ site.baseurl }}/images/monetization/feedback.png" >
